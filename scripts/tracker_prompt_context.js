...
export const TRACKER_VARIABLE_GUIDE_PROMPT = [
  ...
  '- profile 主要包含 cooldown、base、pregnant、experience、psychology、children、metabolism、descriptions、notify。',
  ...
  '',
  '[cooldown]',
  '- orgasmOvulationUsed: 本轮或本阶段是否已经触发过非排卵期高潮排卵。',
  '- laborResistanceUsed: 当天是否已成功进行过一次分娩抵抗；为 true 时，当天内不会再次自动触发产前阵痛，跨天后才会解锁。',
  '',
  '[base]',
...
export function buildMainFlowStatePrompt(payload = {}) {
  ...
  return [
    ...
    '写主线剧情时，你可以参考这些角色变量来理解角色当下的生理与心理状态。',
